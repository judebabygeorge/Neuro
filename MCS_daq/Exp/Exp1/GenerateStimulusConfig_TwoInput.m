...
%p different patterns , r electrodes at a time
 ...
 StimConfig.PulseInterval_1 = 10              ; 
 StimConfig.PulseInterval_2 = 5               ; 
 ...
 for i=1:nG
     ...
     StimConfig.PatternDelay(1,((i-1)*4+1):i*4) = [(2*StimConfig.PulseInterval - StimConfig.PulseInterval_1) (2*StimConfig.PulseInterval - StimConfig.PulseInterval_2) (2*StimConfig.PulseInterval - StimConfig.PulseInterval_1) (2*StimConfig.PulseInterval - StimConfig.PulseInterval_2)];
     %Stim Electrode 2
     StimConfig.Patterns(2,((i-1)*4+1):i*4) = [ElectrodeSets(2,i) ElectrodeSets(2,i) ElectrodeSets(1,i) ElectrodeSets(1,i)];
     StimConfig.PatternDelay(2,((i-1)*4+1):i*4) = [StimConfig.PulseInterval_1 (StimConfig.PulseInterval_2)  StimConfig.PulseInterval_1 (StimConfig.PulseInterval_2)];
