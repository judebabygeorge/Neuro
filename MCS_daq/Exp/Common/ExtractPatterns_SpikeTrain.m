function [Pattern FrameNumber  MarkTime] = ExtractPatterns_SpikeTrain(fr,Config,window)
...
Pattern     = ones(nElectrodes,nSpikes,nPatterns,nPresentations)*NaN ;
FrameNumber = zeros(1,1,nPatterns,nPresentations);
      ...
      [SpikeCounts SpikeTimes StimConfig StimEvents ~] =  get_compressed_stream(fr,Frame);
               ...
               for i=1:size(StimConfig,2)
                    ...
                    if(ExtractResponse==1)
                        ...
                        P = Get_StimResponse_SpikeTrain(SpikeCounts,SpikeTimes,iMarkTime,window,nSpikes);                        
                        Id = iPattern;
                        P(Mask,:) = NaN ;
                        Pattern(:,:,Id,cPresentation) = P;
                        FrameNumber(1,1,Id,cPresentation)= Frame ;
                        MarkTime(1,1,Id,cPresentation)= iMarkTime ;
                    end
