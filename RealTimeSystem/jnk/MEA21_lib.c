...
#pragma DATA_ALIGN(MonitorData, 8);
...
void MEA21_init()
{
    ...
    //This makes the first word at offset(1) from the start of data aligned to 8 byte boundary
    SetMonitorSize(64);
...
void init_dma()
{
	...
	CSL_FINS(ParmsetGPINT4RLD->DST, EDMA3CC_DST_DST, (Uint32)&MeaData[1]); //TODO: Start Here for correct alignment for the data
...
void init_qdma()
{
	...
	CSL_FINS(ParmsetQDMA->SRC, EDMA3CC_SRC_SRC, (Uint32)&MeaData[1]); //TODO: Start Here for correct alignment for the data
