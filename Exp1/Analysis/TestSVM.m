...
Samples(isnan(x))=0;
a = size(Samples)                          ;
Samples = reshape(Samples,[a(1) a(2)*a(3)]);
Labels  = repmat(1:1:a(2),[1 a(3)])   ;
...
[AlphaY, SVs, Bias, Parameters, nSV, nLabel] = LinearSVC(Samples, Labels,0.1);
...
[newLabels, DecisionValue]= SVMClass(Samples,AlphaY,SVs, Bias, Parameters, nSV, nLabel);
% end of the testing
