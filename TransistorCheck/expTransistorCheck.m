classdef expTransistorCheck < handle
    ...
    methods
        ...
        function start(exp)
            ...
            %Electrodes for the Current Pattern Execution are made non_zero
            %so that triggers would be enabled
            exp.Config.Electrodes      = zeros(3,1);
