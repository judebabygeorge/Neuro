...
%            guidata(DS.GUI.TransistorSignalView,handles);
        ...
        function DownLoadCode(DS)
            ...
            %filename = 'C:\Users\45c\Firmware\RealTimeSystem_03MAR2014\bin\RealTimeSystem.bin';
...
%                   DS.Test.data_available(Event,DS.ProcessInfo.spike_times,DS.ProcessInfo.spikeCounts,StimConfig,StimEvents);
        ...
        function SetADCGain(DS,Gain)
            SendCommand(DS,15,Gain)
        end
        function SetBlankingEnable(DS,Enable)
            SendCommand(DS,16,Enable)
        end
    end
